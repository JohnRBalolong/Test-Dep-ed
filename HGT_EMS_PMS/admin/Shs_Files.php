  ...
  <a class="navbar-brand m-0 d-flex align-items-center">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-danger" href="../admin/Shs_Files.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-danger shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Upload Senior High School Files to get data table</h6>
              </div>
            </div>
        ...
        success: function(data) {
            ...
            responses.forEach(function(response) {
                if (Array.isArray(response.data)) {
                    ...
                    } else if (response.sheetName === "Table 7") {
