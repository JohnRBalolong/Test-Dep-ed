...
if (!empty($_FILES['files']['name'])) {
    ...
    foreach ($_FILES['files']['name'] as $key => $value) {
        ...
        $targetSheetNames = ['Table 6', 'Table 7'];
        ...
        foreach ($targetSheetNames as $targetSheetName) {
            ...
            if ($sheet !== null) {
                ...
                $startRow = ($targetSheetName === 'Table 6') ? 10 : 10;
                $endRow = ($targetSheetName === 'Table 6') ? 46 : 17;

                // Define the columns (B, L, O, R) for both tables
                $columns = ($targetSheetName === 'Table 6') ? ['C', 'M', 'P', 'S'] : ['C', 'M', 'P', 'S'];
